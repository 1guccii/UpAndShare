...
fun DarkModeBar() {
    Row(
        ...
        Icon(imageVector = ImageVector.vectorResource(id = R.drawable.dark), contentDescription = "Dark Icon")
        Text(text = "Dark Mode", style = Typography.labelMedium)
